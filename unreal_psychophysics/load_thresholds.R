...
load_thresholds<-function(folder_names,sub_n,study){
...
jnd_thresholds<-import(here("Studies",study,folder_names[[1]],folder_names[[2]],filename2))

#load staircase csv
filename3<-gsub(" ","",paste("staircase_values_sub_",as.character(sub_n),".csv"))
raw_data<-import(here("Studies",study,folder_names[[1]],folder_names[[2]],filename3))
...
export(unreal_rt,here("Studies",study,folder_names[[1]],folder_names[[2]],folder_names[[3]],filename),col.names=FALSE)
...
export(unreal_training,here("Studies",study,folder_names[[1]],folder_names[[2]],folder_names[[3]],filename),col.names=FALSE)
